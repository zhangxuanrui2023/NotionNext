...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。   ！已更改！
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '伦敦的雨', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '欢迎回来', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.laohu717.us.kg', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/zhangxuanrui2023/own-picture-Repository/main/icon.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '恭喜发财',
      artist: '刘德华',
      url: 'https://www.kumeiwp.com/wj/227024/2025/01/01/a05047fb964e09552384858efa1a9e78.mp3',
      cover:
